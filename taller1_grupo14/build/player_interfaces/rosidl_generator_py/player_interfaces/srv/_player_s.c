...
bool player_interfaces__srv__player__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("player_interfaces.srv._player.Player_Request", full_classname_dest, 44) == 0);
  }
  player_interfaces__srv__Player_Request * ros_message = _ros_message;
  {  // nombre
...
PyObject * player_interfaces__srv__player__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("player_interfaces.srv._player");
...
ROSIDL_GENERATOR_C_EXPORT
bool player_interfaces__srv__player__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("player_interfaces.srv._player.Player_Response", full_classname_dest, 45) == 0);
  }
  player_interfaces__srv__Player_Response * ros_message = _ros_message;
  {  // respuesta
