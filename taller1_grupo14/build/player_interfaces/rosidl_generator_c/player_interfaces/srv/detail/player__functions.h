...
#ifndef PLAYER_INTERFACES__SRV__DETAIL__PLAYER__FUNCTIONS_H_
#define PLAYER_INTERFACES__SRV__DETAIL__PLAYER__FUNCTIONS_H_
 ...
 * calls
 * player_interfaces__srv__Player_Request__init().
...
/**
 * It calls
 * player_interfaces__srv__Player_Request__fini()
 ...
 * player_interfaces__srv__Player_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * player_interfaces__srv__Player_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * player_interfaces__srv__Player_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_player_interfaces
...
/**
 * It calls
 * player_interfaces__srv__Player_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_player_interfaces
...
/**
 * It allocates the memory for the array and calls
 * player_interfaces__srv__Player_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_player_interfaces
...
/**
 * It calls
 * player_interfaces__srv__Player_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PLAYER_INTERFACES__SRV__DETAIL__PLAYER__FUNCTIONS_H_
