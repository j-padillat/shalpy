...
#include "example_interfaces/msg/detail/banner__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::msg::Banner & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::msg::Banner & ros_message)
{
  // Member: banner
  cdr >> ros_message.banner;
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Banner *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::Banner *>(
    untyped_ros_message);
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Banner__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, Banner)() {
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Banner__handle;
}
