...
#ifndef EXAMPLE_INTERFACES__SRV__DETAIL__COMIMAGEN__FUNCTIONS_H_
#define EXAMPLE_INTERFACES__SRV__DETAIL__COMIMAGEN__FUNCTIONS_H_
...
/// Initialize srv/Comimagen message.
/**
...
/// Finalize srv/Comimagen message.
/**
...
/// Create srv/Comimagen message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * example_interfaces__srv__Comimagen_Request__init().
...
/// Destroy srv/Comimagen message.
/**
 * It calls
 * example_interfaces__srv__Comimagen_Request__fini()
...
/// Check for srv/Comimagen message equality.
/**
...
/// Initialize array of srv/Comimagen messages.
/**
...
/// Finalize array of srv/Comimagen messages.
/**
 * It calls
 * example_interfaces__srv__Comimagen_Request__fini()
...
/// Create array of srv/Comimagen messages.
/**
 * It allocates the memory for the array and calls
 * example_interfaces__srv__Comimagen_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Comimagen messages.
/**
 * It calls
 * example_interfaces__srv__Comimagen_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Comimagen message array equality.
/**
...
/// Copy an array of srv/Comimagen messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * example_interfaces__srv__Comimagen_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_example_interfaces
...
/**
 * It calls
 * example_interfaces__srv__Comimagen_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_example_interfaces
...
/**
 * It allocates the memory for the array and calls
 * example_interfaces__srv__Comimagen_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_example_interfaces
...
/**
 * It calls
 * example_interfaces__srv__Comimagen_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // EXAMPLE_INTERFACES__SRV__DETAIL__COMIMAGEN__FUNCTIONS_H_
