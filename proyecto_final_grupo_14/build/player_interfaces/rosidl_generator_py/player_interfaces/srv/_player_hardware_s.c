...
bool player_interfaces__srv__player_hardware__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("player_interfaces.srv._player_hardware.PlayerHardware_Request", full_classname_dest, 61) == 0);
  }
  player_interfaces__srv__PlayerHardware_Request * ros_message = _ros_message;
  {  // nombre
...
{
  /* NOTE(esteve): Call constructor of PlayerHardware_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("player_interfaces.srv._player_hardware");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlayerHardware_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool player_interfaces__srv__player_hardware__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("player_interfaces.srv._player_hardware.PlayerHardware_Response", full_classname_dest, 62) == 0);
  }
  player_interfaces__srv__PlayerHardware_Response * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of PlayerHardware_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("player_interfaces.srv._player_hardware");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlayerHardware_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
