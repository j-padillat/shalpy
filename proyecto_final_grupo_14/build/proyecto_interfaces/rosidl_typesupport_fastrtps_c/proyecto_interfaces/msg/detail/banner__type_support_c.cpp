...
#include "proyecto_interfaces/msg/detail/banner__rosidl_typesupport_fastrtps_c.h"
...
using _Banner__ros_msg_type = proyecto_interfaces__msg__Banner;
...
size_t get_serialized_size_proyecto_interfaces__msg__Banner(
  const void * untyped_ros_message,
...
static uint32_t _Banner__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_proyecto_interfaces__msg__Banner(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_proyecto_interfaces
size_t max_serialized_size_proyecto_interfaces__msg__Banner(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Banner__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_proyecto_interfaces__msg__Banner(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, proyecto_interfaces, msg, Banner)() {
