...
{
  new (message_memory) example_interfaces::msg::Banner(_init);
}

void Banner_fini_function(void * message_memory)
{
  auto typed_message = static_cast<example_interfaces::msg::Banner *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Banner_message_member_array[4] = {
  {
    ...
    offsetof(example_interfaces::msg::Banner, banner),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces::msg::Banner, figure),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces::msg::Banner, word),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces::msg::Banner, color),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Banner_message_members = {
  ...
  "Banner",  // message name
  4,  // number of fields
  sizeof(example_interfaces::msg::Banner),
...
{
  return &::example_interfaces::msg::rosidl_typesupport_introspection_cpp::Banner_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, msg, Banner)() {
  return &::example_interfaces::msg::rosidl_typesupport_introspection_cpp::Banner_message_type_support_handle;
}
