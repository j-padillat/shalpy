...
class Metaclass_StartNavigationTest(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'proyecto_interfaces.srv.StartNavigationTest')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from proyecto_interfaces.srv import _start_navigation_test
...
class StartNavigationTest(metaclass=Metaclass_StartNavigationTest):
    from proyecto_interfaces.srv._start_navigation_test import StartNavigationTest_Request as Request
    from proyecto_interfaces.srv._start_navigation_test import StartNavigationTest_Response as Response
