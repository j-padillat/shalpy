...
#include "player_interfaces/msg/detail/trace__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const player_interfaces::msg::Trace & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  player_interfaces::msg::Trace & ros_message)
{
  // Member: key
  cdr >> ros_message.key;
...
{
  auto typed_message =
    static_cast<const player_interfaces::msg::Trace *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<player_interfaces::msg::Trace *>(
    untyped_ros_message);
...
{
  return &player_interfaces::msg::typesupport_fastrtps_cpp::_Trace__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, player_interfaces, msg, Trace)() {
  return &player_interfaces::msg::typesupport_fastrtps_cpp::_Trace__handle;
}
