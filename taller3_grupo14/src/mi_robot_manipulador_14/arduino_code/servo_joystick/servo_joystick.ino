...
void loop() {
  ...
  float ang_Joint2 = initial_position3 - 90;
  ...
  float pos_X = link1 * cos(rad_ang1) + link2 * cos(rad_ang1 + rad_ang2);
  float pos_Y = link1 * sin(rad_ang1) + link2 * sin(rad_ang1 + rad_ang2);
